...
#define VTD_IOTLB_SIZE              1024    /* Entries in IOTLB */
#define VTD_IOTLB_MASK              (VTD_IOTLB_SIZE - 1ULL)
...
#define VTD_INV_DESC_WAIT_RSVD_HI   (0x3ULL)
...
#define VTD_INV_DESC_IOTLB_ADDR(val) \
                                ((val) & ~0xfffULL & ((1ULL << VTD_MGAW) - 1))
